...
<body>
  <div class="container">
    <p class="font-97 clay-text">{{ $match->localTeam->name }}</p>
    <p class="font-146 cyan-text score">{{ $match->local_score }}</p>
    <p class="font-97 clay-text score-team">{{ $match->guestTeam->name }}</p>
    <p class="font-146 cyan-text score">{{ $match->guest_score }}</p>
  </div>
</body>
<style>
  @page {
  ...
  body {
    ...
    padding: 17pt;
    background-image: url('../storage/images/template-final.png');
