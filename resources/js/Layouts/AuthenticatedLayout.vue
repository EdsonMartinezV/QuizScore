                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('quizMatches.index')">
                                    <ApplicationLogo
                                        class="block h-12 -ml-11 fill-current text-gray-800 dark:text-gray-200"
                                    />
                                </Link>
                            </div>

                            <!-- Navigation Links -->
                            <div class="space-x-8 sm:-my-px sm:ms-10 sm:flex min-[0px]:hidden max-[640px]:hidden">
                        ...
                        <div class="sm:flex sm:items-center sm:ms-6 min-[0px]:hidden max-[640px]:hidden">
                            <!-- Settings Dropdown -->
                ...
                >
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink :href="route('logout')" method="post" as="nickbutton">
                                Cerrar Sesión
                            </ResponsiveNavLink>
                        </div>
                    </div>
