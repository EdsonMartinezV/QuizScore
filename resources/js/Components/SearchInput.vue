...
<template>
  <div class="mt-4 rounded-md p-2 shadow-md" @mouseleave="showSelect = false">
    ...
    <Transition
      ...
      leave-to-class="opacity-0 scale-95" >
        <SelectItems v-if="showSelect" :results="queryResults.data" :display-fields="props.displayFields" :id-name="props.idName" @item-clicked="showResult" :is-first-word-bold="props.isFirstWordBold" />
    </Transition>
